...
class Metaclass_Service_Response(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if Markers.__class__._TYPE_SUPPORT is None:
                Markers.__class__.__import_type_support__()
...
class Service_Response(metaclass=Metaclass_Service_Response):
    ...
    _fields_and_field_types = {
        'markers': 'arucosrvmsg/Markers',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['arucosrvmsg', 'msg'], 'Markers'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        assert all('_' + key in self.__slots__ for key in kwargs.keys()), \
            ...
            ', '.join(sorted(k for k in kwargs.keys() if '_' + k not in self.__slots__))
        from arucosrvmsg.msg import Markers
        self.markers = kwargs.get('markers', Markers())
    ...
    def markers(self, value):
        if __debug__:
            from arucosrvmsg.msg import Markers
            assert \
                isinstance(value, Markers), \
                "The 'markers' field must be a sub message of type 'Markers'"
        self._markers = value
...
class Metaclass_Service(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from arucosrvmsg.srv import _service
...
class Service(metaclass=Metaclass_Service):
    from arucosrvmsg.srv._service import Service_Request as Request
    from arucosrvmsg.srv._service import Service_Response as Response
