...
bool arucosrvmsg__msg__aruco_markers__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("arucosrvmsg.msg._aruco_markers.ArucoMarkers", full_classname_dest, 43) == 0);
  }
  arucosrvmsg__msg__ArucoMarkers * ros_message = _ros_message;
  {  // ids
...
PyObject * arucosrvmsg__msg__aruco_markers__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("arucosrvmsg.msg._aruco_markers");
