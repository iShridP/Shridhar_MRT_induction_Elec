...
#include "arucosrvmsg/msg/detail/aruco_markers__rosidl_typesupport_fastrtps_c.h"
...
using _ArucoMarkers__ros_msg_type = arucosrvmsg__msg__ArucoMarkers;
...
size_t get_serialized_size_arucosrvmsg__msg__ArucoMarkers(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ArucoMarkers__ros_msg_type * ros_message = static_cast<const _ArucoMarkers__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ArucoMarkers__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_arucosrvmsg__msg__ArucoMarkers(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_arucosrvmsg
size_t max_serialized_size_arucosrvmsg__msg__ArucoMarkers(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = arucosrvmsg__msg__ArucoMarkers;
    is_plain =
      (
...
static size_t _ArucoMarkers__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_arucosrvmsg__msg__ArucoMarkers(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arucosrvmsg, msg, ArucoMarkers)() {
