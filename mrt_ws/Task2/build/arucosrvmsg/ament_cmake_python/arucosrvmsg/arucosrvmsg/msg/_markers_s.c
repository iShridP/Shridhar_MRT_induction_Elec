...
bool arucosrvmsg__msg__markers__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("arucosrvmsg.msg._markers.Markers", full_classname_dest, 32) == 0);
  }
  arucosrvmsg__msg__Markers * ros_message = _ros_message;
  {  // corners
...
PyObject * arucosrvmsg__msg__markers__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("arucosrvmsg.msg._markers");
