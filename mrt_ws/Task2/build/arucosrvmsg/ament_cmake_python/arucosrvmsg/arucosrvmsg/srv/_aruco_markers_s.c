...
bool arucosrvmsg__srv__aruco_markers__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("arucosrvmsg.srv._aruco_markers.ArucoMarkers_Request", full_classname_dest, 51) == 0);
  }
  arucosrvmsg__srv__ArucoMarkers_Request * ros_message = _ros_message;
  {  // image
...
{
  /* NOTE(esteve): Call constructor of ArucoMarkers_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("arucosrvmsg.srv._aruco_markers");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ArucoMarkers_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool arucosrvmsg__srv__aruco_markers__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("arucosrvmsg.srv._aruco_markers.ArucoMarkers_Response", full_classname_dest, 52) == 0);
  }
  arucosrvmsg__srv__ArucoMarkers_Response * ros_message = _ros_message;
  {  // ids
  ...
  {  // bounding_boxes
    ...
    geometry_msgs__msg__Polygon * dest = ros_message->bounding_boxes.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
...
{
  /* NOTE(esteve): Call constructor of ArucoMarkers_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("arucosrvmsg.srv._aruco_markers");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ArucoMarkers_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
