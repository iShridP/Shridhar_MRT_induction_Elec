...
static const _ArucoMarkers_type_support_symbol_names_t _ArucoMarkers_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, arucosrvmsg, msg, ArucoMarkers)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, arucosrvmsg, msg, ArucoMarkers)),
  }
};
...
{
  return &::arucosrvmsg::msg::rosidl_typesupport_cpp::ArucoMarkers_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, arucosrvmsg, msg, ArucoMarkers)() {
  return get_message_type_support_handle<arucosrvmsg::msg::ArucoMarkers>();
}
