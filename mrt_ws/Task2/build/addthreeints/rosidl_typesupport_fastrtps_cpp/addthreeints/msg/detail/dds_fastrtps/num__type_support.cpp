...
#include "addthreeints/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const addthreeints::msg::Num & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  addthreeints::msg::Num & ros_message)
{
  // Member: num
  cdr >> ros_message.num;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = addthreeints::msg::Num;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const addthreeints::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<addthreeints::msg::Num *>(
    untyped_ros_message);
...
get_message_type_support_handle<addthreeints::msg::Num>()
{
  return &addthreeints::msg::typesupport_fastrtps_cpp::_Num__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, addthreeints, msg, Num)() {
  return &addthreeints::msg::typesupport_fastrtps_cpp::_Num__handle;
}
