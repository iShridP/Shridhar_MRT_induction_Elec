...
#include "addthreeints/msg/detail/sphere__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = addthreeints::msg::Sphere;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const addthreeints::msg::Sphere *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<addthreeints::msg::Sphere *>(
    untyped_ros_message);
...
{
  return &addthreeints::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
