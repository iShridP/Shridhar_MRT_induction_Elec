...
static const _Markers_type_support_symbol_names_t _Markers_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arucosrvmsg, msg, Markers)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, arucosrvmsg, msg, Markers)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, arucosrvmsg, msg, Markers)() {
  return &::arucosrvmsg::msg::rosidl_typesupport_c::Markers_message_type_support_handle;
}
