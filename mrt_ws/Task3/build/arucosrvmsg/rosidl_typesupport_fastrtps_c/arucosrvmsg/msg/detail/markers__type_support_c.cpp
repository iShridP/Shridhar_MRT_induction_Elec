...
#include "arucosrvmsg/msg/detail/markers__rosidl_typesupport_fastrtps_c.h"
...
using _Markers__ros_msg_type = arucosrvmsg__msg__Markers;
...
static uint32_t _Markers__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_arucosrvmsg__msg__Markers(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = arucosrvmsg__msg__Markers;
    is_plain =
      (
...
static size_t _Markers__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_arucosrvmsg__msg__Markers(
