...
static const _Service_Request_type_support_symbol_names_t _Service_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, arucosrvmsg, srv, Service_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, arucosrvmsg, srv, Service_Request)),
  }
};
...
{
  return &::arucosrvmsg::srv::rosidl_typesupport_cpp::Service_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, arucosrvmsg, srv, Service_Request)() {
  return get_message_type_support_handle<arucosrvmsg::srv::Service_Request>();
}
...
static const _Service_Response_type_support_symbol_names_t _Service_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, arucosrvmsg, srv, Service_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, arucosrvmsg, srv, Service_Response)),
  }
};
...
{
  return &::arucosrvmsg::srv::rosidl_typesupport_cpp::Service_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, arucosrvmsg, srv, Service_Response)() {
  return get_message_type_support_handle<arucosrvmsg::srv::Service_Response>();
}
...
static const _Service_type_support_symbol_names_t _Service_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, arucosrvmsg, srv, Service)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, arucosrvmsg, srv, Service)),
  }
};
...
{
  return &::arucosrvmsg::srv::rosidl_typesupport_cpp::Service_service_type_support_handle;
}
