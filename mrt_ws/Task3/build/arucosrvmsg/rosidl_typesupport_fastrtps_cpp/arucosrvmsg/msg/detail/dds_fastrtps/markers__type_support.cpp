...
#include "arucosrvmsg/msg/detail/markers__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = arucosrvmsg::msg::Markers;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const arucosrvmsg::msg::Markers *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<arucosrvmsg::msg::Markers *>(
    untyped_ros_message);
...
{
  return &arucosrvmsg::msg::typesupport_fastrtps_cpp::_Markers__handle;
}
